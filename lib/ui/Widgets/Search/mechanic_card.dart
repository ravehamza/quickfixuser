...
import 'package:quickfixuser/Resources/ui/ForveelTile.dart';
...
class _MechanicCardState extends State<MechanicCard> {
  ...
  Widget build(BuildContext context) {
    if(widget.data ==  null || widget.data.toString().isEmpty){
      return Center(
      ...
      return  ForveelTile(
        ...
        middle:  <Widget>[
          ...
          widget.data['rating'].toString().isEmpty ?Row(
              children: List.generate(
                  int.parse(widget.data['rating']['value'].toString().split(".")[0]).floor(), (index) {
                return
