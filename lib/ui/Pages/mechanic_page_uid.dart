...
import 'package:quickfixuser/Resources/ui/MechanicPageVidgets.dart';
import 'package:quickfixuser/ui/Mycolors.dart';
import 'package:quickfixuser/ui/Widgets/Request/alertbox.dart';
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.all(20),
                    child:_mechanic['rating']['value'].toString().isEmpty? Row(
